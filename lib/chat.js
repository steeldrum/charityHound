  ...
  connect : function ( server ) {
    ...
    io
      ...
      .on( 'connection', function ( socket ) {
        ...
        socket.on( 'adduser', function ( user_map ) {
          ...
          crud.read(
            ...
            function ( result_list ) {
              var
                result_map,
                cid = user_map.cid;  // i.e. email
              // tjs 131021
              //alert("chat adduser cid " + cid);
              delete user_map.cid;
        ...
        // tjs 131018
        // Begin /profileuser/ message handler
        // Summary   : Provides sign in capability.
        // Arguments : A single user_map object.
        //   user_map should have the following properties:
        //     name    = the name of the user
        ...
        //     originated the 'adduser' message.
        //
        socket.on( 'profileuser', function ( user_map ) {
          crud.read(
            'user',
            //{ _id : user_map.id },
            { _id : user_map.cid },
            ...
            function ( result_list ) {
              ...
              if ( result_list.length > 0 ) {
                ...
                // tjs 131022
                //signIn( io, result_map, socket );
          	  socket.emit( 'userprofiled', result_map );
              }

              // create user with new name
              else {
                  //seekProfile( user_map );
            	  socket.emit( 'usernotprofiled', user_map );
            	  /*
                user_map.is_online = true;
                crud.construct(
                  'user',
        ...
        // End /profileuser/ message handler
