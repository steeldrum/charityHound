...
class Donation extends DataObject {
	...
	// tjs 140208
		...
		// tjs 140210 ensure connection reused...
			//public static function deriveDonationInfo4Charity( $account, $isSelectableForSite, $charityId, $fromYear, $toYear ) {
	public static function deriveDonationInfo4Charity( $account, $isSelectableForSite, $charityId, $connection, $fromYear, $toYear ) {
		...
		if ($account > 0) {
			...
			// tjs 140208 for debug:
			//echo "isSelectableForSite >>>>> $isSelectableForSite";
		...
		//$rate = $isSelectableForSite;
		// tjs 140210
		//return array( $solicitationsCount, $rate, $donationsCount, $average, $lastAmount );
		return array( $solicitationsCount, $rate, $donationsCount, $average, $lastAmount, $conn );
	}

	public static function dropconnect($conn) {
		parent::disconnect( $conn );
	}
