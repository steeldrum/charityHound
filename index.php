...
// tjs 141030
    	...
    	console.log("index ready url " + authenticationReferenceURL);
       ...
       var user = authRef.getAuth();
        ...
        if (user) {
                ...
                userRef.once('value', function (snap) {
                    ...
                    if (!authUser) {
                        console.log("authentication authWithPassword NO user!");
                    } else {
                    // the fields
					...
					console.log("index ready no user account " + account);
					processArgs(account);
        }
