...
<p>
There is a possibility that you are undecided about giving anything.  Perhaps you plan to research the cause further.  Indeed this is quite typical.  In such cases log the solicitation with a zero amount anyway.  Later on the same charity can be found (search in the Charities panel).  Then use the magnifying glass (icon) to immediately display the lower list of "Donations".  Perhaps the most recent donation shows a "zero" amount.  But you now plan to write a check (<a href="DeluxeChecks4CharityHound.pdf">See ideas to make check print easy</a>).  In the lower list simply click the pencil icon (edits that list item).  A form is displayed.  Change the amount from zero to whatever you plan to donate.  Submit the form and you are done!
</p>
<p>
